...
# one gibson-peg-turner tuner_case_v2 prints with) — NOT gramil's older vendored
...
def _print_layout(
    ...
    Transform sequence copied from gramil tools/assemble_case_with_pip_hinge.py
