...
## What's Changed
* fix: make brim easier to remove from the case by @pzfreo in https://github.com/pzfreo/gramel/pull/66


**Full Changelog**: https://github.com/pzfreo/gramel/compare/v0.1.10...v0.1.11
