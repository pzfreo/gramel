...
| **Working face** | Right-hand long face of the shank. Convex profile with a vertical relief slot, full length. |
...
| **Relief slot** | Vertical slot down the centre of the working face, full length of the shank. |
| **Shaft cross-bore** | Plain horizontal through-hole near the top of the shank. Sliding fit on the shaft. |
| **Shank tapped bore** | Tapped horizontal through-hole, directly above and parallel to the shaft cross-bore. Carries the drive screw. |
| **Depth-lock blind bore** | Long vertical tapped hole running up inside the shank from the bottom. Carries the depth-lock bolt. Opens into the shaft cross-bore from below. |
...
| **Depth-lock bolt** | Long bolt running vertically inside the depth-lock blind bore. Knurled knob at the bottom. Its upper end bears directly on the underside of the shaft, clamping the shaft in Y. |
...
**Locking the setting.** The depth-lock knob, at the bottom of the shank, is on the end of a long bolt running up inside the depth-lock blind bore. Tightening the knob advances the bolt up the bore until its tip bears on the underside of the shaft (which crosses through the upper part of the shank). This pinches the shaft against the upper wall of the shaft cross-bore and locks it in Y.
